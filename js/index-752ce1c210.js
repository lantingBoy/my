...
/***/ function(module, exports, __webpack_require__) {
	...
	$('.me').tap(function(){
		...
		var danmu=document.getElementById('danmu');
	        ...
	        var speak=['前端小生','爱生活','熟悉iscroll、swiper类库','爱学习','爱美女','风流倜傥','熟悉Jquery、Zepto、AngularJs、Recat、Avalon等框架','精通:"Fixed、Fulid、Flex、Responsive"布局','了解"HTML4、HTML5、ES5、ES6、CommonJS、CMD、AMD等"','爱LOL','音乐','运动','爱科技','爱前端'];
	        function insert(){
	            var newli=document.createElement('div');
	            var randomS=Math.floor(Math.random()*13);
	            ...
	            newli.style.background='rgb('+b+','+r+','+g+')';
	            var t=winH-60;
	...
	//引入swiper animate
	var  SwiperAnimate=__webpack_require__(17);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Zepto = __webpack_require__(8);
