	 ...
	 /* $('.me').tap(function(){
		...
		$('#danmu').show();
	  	...
	  	var danmu=document.getElementById('danmu');
	        ...
	        var speak=['前端小生','爱生活','熟悉iscroll、swiper类库','爱学习','了解"HTML4、HTML5、ES5、ES6、CommonJS"''爱美女','风流倜傥','Jquery、Zepto、AngularJs、Recat、Avalon','精通:"Fixed、Fulid、Flex、Responsive"布局',,'爱LOL'];
	        function insert(){
