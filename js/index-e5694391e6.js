...
/***/ function(module, exports, __webpack_require__) {
	...
	$('.tap_more').tap(function(){
		...
		var danmu=document.getElementById('danmu');
	        ...
	        var speak=['前端小生','爱生活','熟悉iscroll、swiper类库','爱学习','爱美女','风流倜傥','熟悉Jquery、Zepto、AngularJs、Recat、Avalon等框架','精通:"Fixed、Fulid、Flex、Responsive"布局','了解"HTML4、HTML5、ES5、ES6、CommonJS、CMD、AMD等"','爱LOL','爱音乐','爱运动','爱科技','爱前端'];
	        function insert(){
